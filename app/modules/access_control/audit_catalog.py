...
class AuditEventType(StrEnum):
    ...
    ORGANIZATION_ROLE_ACCESS_DENIED = "organization_role.access_denied"
    PROVISIONER_BOOTSTRAP_CREATE = "provisioner.bootstrap_create"
    PROVISIONER_CREATE_CASE_HEAD = "provisioner.create_case_head"
    PROVISIONER_UPDATE_CASE_HEAD = "provisioner.update_case_head"
    ...
    ACCOUNT_RESET_CREDENTIALS = "account.reset_credentials"
    CASE_CREATE = "case.create"
    CASE_MEMBER_ADD = "case.member_add"
    CASE_MEMBER_UPDATE = "case.member_update"
    CASE_MEMBER_DEACTIVATE = "case.member_deactivate"
    CASE_CREATE_TEAM_MEMBER = "case.create_team_member"
    FIRST_PROVISIONER_SETUP = "provisioner.first_setup"
