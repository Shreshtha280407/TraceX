...
- **No SSO, no external identity provider.** `app/modules/access_control/` added TOTP-based MFA (ADR-033); SAML/OIDC and third-party identity providers remain out of scope.
